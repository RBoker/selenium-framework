...
public class BlogAgiHomePage extends BasePage {
    ...
    /**
     * Ícone de busca (tema Astra/WordPress).
     *
     * Observação:
     * - esse componente pode existir mais de uma vez no DOM (alguns invisíveis),
     *   por isso o click deve ser feito no primeiro elemento visível.
     */
    private static final By SEARCH_ICON =
            By.cssSelector("a.slide-search.astra-search-icon, a.astra-search-icon");

    /**
     * Input de busca (só fica visível após abrir o overlay).
     */
    ...
    public void search(String term) {
        ...
        // 0) garante desktop (evita DOM mobile)
